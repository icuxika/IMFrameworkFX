...
- 其他说明：
  ...
  -
  非模块化的打包方式制作出来的安装包相比模块化的方式大一些，所以如果项目比较新，并且所用到的第三方库支持模块化的话，可以按照[JavaFX-Package-Sample](https://github.com/icuxika/JavaFX-Package-Sample)
  ，其中`gradle`方式的插件可以自动模块化一些非模块化的第三方库，大部分情况下能解决问题。
