...
public class GraphValidateCodeController {
    ...
    public void initialize() {
        titleLabel.textProperty().bind(MainApp.getLanguageBinding(LanguageConstants.verification_code));
        ...
        JFXTooltip.install(refreshIcon, new JFXTooltip(MainApp.getLanguageBinding(LanguageConstants.re_obtain_verification_code)));
        ...
        validator.messageProperty().bind(MainApp.getLanguageBinding(LanguageConstants.verification_code_need));
        ...
        confirmButton.textProperty().bind(MainApp.getLanguageBinding(LanguageConstants.confirm));
        ...
        cancelButton.textProperty().bind(MainApp.getLanguageBinding(LanguageConstants.cancel));
